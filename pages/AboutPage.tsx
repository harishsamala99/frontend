...
const AboutPage = () => (
    <PageWrapper>
        ...
        <div className="max-w-sm mx-auto bg-white p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-slate-200">
            <img src={HOUSE_CLEANER.imageUrl} alt={HOUSE_CLEANER.name} className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-teal-100" />
            <h3 className="text-xl font-semibold text-gray-800">{HOUSE_CLEANER.name}</h3>
            <p className="text-teal-600 font-medium mb-2">{HOUSE_CLEANER.role}</p>
